...
public class Ecommsitetest {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("userEmail")).sendKeys("nagendrrks@gmail.com");
		driver.findElement(By.id("userPassword")).sendKeys("Pursuit94");
...
//
//	                            driver.findElement(By.cssSelector("div[class*='ng-animating']"))
//
//	                    ));
//
//	                    wait.until(ExpectedConditions.invisibilityOf(
//
//	                            driver.findElement(By.cssSelector("div[class*='ngx-spinner-overlay']"))
//
//	                    ));
//
//	                    break; // Exit the inner loop after finding and clicking the target product
//
//	                }
//
//	            }
